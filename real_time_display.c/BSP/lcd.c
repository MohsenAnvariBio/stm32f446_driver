...
void LCD_PrintTittle(char* message);
void LCD_PrintOpening(void);
...
void LCD_Init(void)
{
    ...
    // keep all these pins as logic 0 initially.
...
void LCD_PrintTittle(char* message)
{
	char* firstMessage = message;
    int dif = strlen(message)-16;
 ...
 * @return      - None
 *
 * @Note        - Set Lcd to a specified location given by row and
