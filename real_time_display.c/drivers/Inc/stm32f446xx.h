...
#define AHB3PERIPH_BASEADDR     0x60000000U     /* Base address of AHB3 peripheral memory */
...
#define UART4_PCLK_EN()     ( RCC->APB1ENR |= (1 << 19) ) /* UART4 peripheral clock enabled */
#define UART5_PCLK_EN()     ( RCC->APB1ENR |= (1 << 20) ) /* UART5 peripheral clock enabled */
...
#define UART4_PCLK_DI()     ( RCC->APB1ENR &= ~(1 << 19) ) /* UART4 peripheral clock disabled */
#define UART5_PCLK_DI()     ( RCC->APB1ENR &= ~(1 << 20) ) /* UART5 peripheral clock disabled */
